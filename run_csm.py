...
MODEL_PATH = "/root/autodl-tmp/csm/model"
PROMPTS_PATH = "/root/autodl-tmp/csm/model/prompts"
prompt_filepath_conversational_a = os.path.join(PROMPTS_PATH, "conversational_a.wav")
prompt_filepath_conversational_b = os.path.join(PROMPTS_PATH, "conversational_b.wav")
